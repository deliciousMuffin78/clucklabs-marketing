      ...
      <footer>
        <div className="max-w-c-1390 mx-auto px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap justify-center gap-8 text-center md:justify-start md:text-left lg:justify-between lg:gap-0">
              <motion.div
                variants={{
                  hidden: {
                    opacity: 0,
                ...
                viewport={{ once: true }}
                className="animate_top flex w-full flex-col items-center md:w-1/2 md:items-start lg:w-1/4"
              >
                ...
                <p className="mt-5 mb-5 text-center text-2xl font-medium text-black md:text-left dark:text-white">
                  It's what you do.
                </p>
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="animate_top flex flex-col items-center md:items-start"
                >
                  <h4 className="mb-9 text-center text-xl font-medium text-black md:text-left dark:text-white">
                    Quick Links
                  </h4>
                ...
                <motion.div
                  ...
                  className="animate_top flex flex-col items-center md:items-start"
                >
                  <div className="mb-4 w-full max-w-[350px] text-center md:text-left">
                    <h4 className="mb-4 text-xl font-medium text-black dark:text-white">
                      Be first to know
                    </h4>
                    <SignupForm
                      ...
                      layout="compact"
                      ctaText="Join"
                      description="Early access invites."
                      descriptionClassName="text-waterloo"
                    />
                  </div>
                  <p className="mt-8 text-lg">
                    &copy; {year} Cluck Labs, Inc. All rights reserved
                  </p>
                </motion.div>
              </div>
            </div>
          ...
          {/* <!-- Footer Bottom --> */}
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 py-7 lg:flex-row lg:justify-end lg:gap-0">
            <motion.div
              variants={{
                hidden: {
                  opacity: 0,
