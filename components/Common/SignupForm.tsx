  ...
  return (
    <div className="flex w-full flex-col items-center gap-5">
      <form
        ...
        className={`w-full ${
          showInterests ? "max-w-[650px]" : "max-w-[500px]"
        }`}
      >
        <div
        ...
        >
          {!showInterests ? (
            <div className="group sm:focus-within:border-primary/70 flex flex-1 flex-col gap-4 sm:flex-row sm:items-center sm:gap-4 sm:rounded-full sm:border-3 sm:bg-white sm:p-0 sm:dark:border-white/30 sm:dark:bg-black/30">
              <input
                value={email}
                ...
                className="border-primary/30 focus:border-primary flex-1 rounded-full border-2 bg-white px-6 py-4 text-black placeholder:text-black/60 focus:outline-hidden sm:border-none sm:bg-transparent sm:px-4 sm:py-2 dark:border-white/30 dark:bg-black dark:text-white dark:placeholder:text-white/70 sm:dark:bg-transparent"
              />
              <button
                type="submit"
                disabled={status === "loading"}
                className="bg-primary hover:bg-primaryho flex items-center justify-center rounded-full px-10 py-4 text-lg font-medium whitespace-nowrap text-white shadow-md transition-all duration-300 sm:py-3"
              >
