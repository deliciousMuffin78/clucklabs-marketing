...
function GradientLayer({
  ...
  const background = useMotionTemplate`radial-gradient(circle at ${x}px ${y}px, ${gradientColor} 55%, transparent 100%)`;
...
export const NoiseBackground = ({
  ...
  const topGradientX = useTransform(springX, (val) => val * 0.1 - 30);
